...
%    \bibitem[AGN97]{AGN97}
%    S.\ Abramsky, S.\ Gay, and R. Nagarajan. 
%    \newblock A type-theoretic approach to deadlock-freedom of asynchronous systems.
%    \newblock In, M.\ Abadi and T.\ Ito, editors, {\sl Theoretical Aspects of
%    Computer Software, International Symposium TACS'97}, Lecture Notes in
%    Computer Science, vol.1281, pp.295--320, Springer Berlin, 1997.
%
    \bibitem[AC04]{AC04}
    ...
    \newblock {\sl Abstract and Concrete Categories: The Joy of Cats}. Online
    edition, 2004.
...
%      \href{http://arxiv.org/abs/1309.2697}{arXiv:1309.2697}.
    ...
    \newblock {\sl Theoretical Computer Science}, 335(2):131--146, 2005.
    ...
    \newblock {\em Theory and Applications of Categories}, { 30}:836--881,
    2015. 
    \newblock Available at
    ...
    \newblock {\sl Journal of Mathematical Physics}, 57(3):033301, 2016.  
    ...
    \newblock {\em C. R. Acad. Sci. Paris}, 256:1887--1890, 1963.
...
%    1950.
    ...
    \bibitem[Bou90]{Bou90}
    N.\ Bourbaki.
    \newblock {\sl Algebra II. Chapters 4--7}. Elements of Mathematics,
...
%    \newblock {\em Theoretical Computer Science}, { 286}(2): 247--292, 2002. 
...
%    \newblock \textsl{Theoretical Computer Science}, { 115}(1):43--62, 1993.
...
%      165--175.
    ...
    \newblock {\sl J.\ Algebra}, 138(2):497--529, 1991.
    ...
    \newblock {\sl Topology} { 44}(4):747--767, 2005. 
...
%    \newblock Kindergarten quantum mechanics.
    ...
    \newblock {\sl Phys. Educ.} { 15}(1):57--61, 1980.
    
    \bibitem[DeM60]{DeM60}
    A.\ De Morgan.
    \newblock {\em Syllabus of a Proposed System of Logic}, Walton and Maberly,
    London, 1860.

    \bibitem[Deu13]{Deu}
    D.\ Deutch.
    \newblock Constructor theory.
    \newblock {\em Synthese}, 190(18):4331--4359, 2013.
...
%    \newblock \textsl{J. Symbolic Logic} { 68}(3):740--750, 2003.
%    \newblock
...
%    \textsl{Annals of Pure and Applied Logic} { 164}(4):443--481, 2013.
%    \href{http://doi.org/10.1016/j.apal.2012.10.008}{doi:10.1016/j.apal.2012.10.008}. 
  ...
  \bibitem[Erb16]{Erb16}
    J.\ Erbele.
    \newblock {\em Categories in Control: applied PROPs.}
    ...
    \newblock {\sl Categories, Allegories}. Mathematical Library 39, North
    Holland, 1990.

    \bibitem[Fri86]{Fr} 
    B.\ Friedland. 
    \newblock {\sl Control System Design: An Introduction to
    ...
    \newblock {\sl Bull. Am. Math. Soc.}, 78:777--783, 1972.
...
%    \newblock \textsl{Theory Appl. Categ.} { 8}:244--252, 2001.
%    \newblock Available at
...
%      2004. 
    ...
    \bibitem[Har23]{H}
    I.\ B.\ Hart.
    \newblock {\sl Makers of Science}, p.\ 243. Oxford U.\ Press, Oxford, 1923.
...
%    \newblock PhD thesis, Princeton University, 2015. 
    ...
    \newblock {\sl The origin of concurrent programming}, pp.413--443, Springer New York, 1978.
    
    \bibitem[Jan86]{Jan86}
    T.\ M.\ V.\ Janssen.
    \newblock {\em Foundations and applications of Montague grammar. Part 1:
    Philosophy, framework, computer science}. CWI tract 19, Centrum voor
    ...
    \newblock {\sl Adv.\ Math.}, { 102}(1):20--78, 1993.
...
%   I think some nice results on Dirichlet forms are proved here.
    ...
    \newblock {\em Illinois Journal of Mathematics}, 14(4):536--550, 1970.

    \bibitem[Lac04]{Lac04} 
    S.\ Lack.
    \newblock Composing PROPs.
    \newblock {\em Theory and Applications of Categories}, { 13}(9):147--163,
    2004.
    \newblock Available at
    \href{http://www.tac.mta.ca/tac/volumes/13/9/13-09abs.html}{http://www.tac.mta.ca/tac/volumes/\linebreak 13/9/13-09abs.html}

    \bibitem[Lac11]{Lac11}
    S.\ Lack.
    \newblock An embedding theorem for adhesive categories.
    \newblock {\em Theory and Applications of Categories}, 25(7)180--188, 2011.
    \newblock Available at
    ...
    \newblock {\sl IEEE Transactions on Circuit Theory}, { 20}(2):169--171, 1973.
    ...
    \bibitem[Mac63a]{Mac63a} 
    S.\ Mac Lane.
    \newblock An algebra of additive relations
    \newblock {\sl Proc.\ Nat.\ Acad.\ Sci.\ U.S.A} { 47}(4):1043--1051, 1963. 

    \bibitem[Mac63b]{Mac63} 
    S.\ Mac Lane.
    \newblock Natural associativity and commutativity.
    \newblock {\sl Rice Univ. Studies}, { 49}(4):28--46, 1963. 

%    \bibitem[Mac65]{Mac65}
%    S.\ Mac\ Lane.
%    \newblock Categorical algebra.
%    \newblock \emph{Bull. Amer. Math. Soc.} { 71}(1):40--106, 1965.
%    \newblock 
%    \href{http://doi.org/10.1090/S0002-9904-1965-11234-4}{doi:10.1090/S0002-9904-1965-11234-4}.
    ...
    \newblock {\sl Proceedings of the Royal Society} no{ 100}, 1868. 
    ...
    \bibitem[Mil00]{Mil00}
    S.\ Milius.
    \newblock {\em Relations in categories}. MA thesis, York University,
    Ontario, 2000.

    \bibitem[Mil80]{Mil80}
    R.\ Milner.
    \newblock {\sl A Calculus of Communicating Systems.}
    \newblock Springer-Verlag (LNCS 92), 1980.

  \bibitem[Mon07]{Mon07}
    M.\ I.\ Monastyrsky.
    \newblock {\sl Topology in Molecular Biology: DNA and Proteins}.
    ...
    \bibitem[Nob06]{Nob06}
    D.\ Noble.
    \newblock {\em The Music of Life: Biology Beyond the Genome}, Oxford
    University Press, Oxford, 2006.

%    \bibitem[Obe90]{Ob}
%    U.\ Oberst.
%    \newblock Multidimensional constant linear systems.
%    \newblock \emph{Acta Applicandae Mathematicae}, 20:1--175, 1990.
...
%      Mathematical Theory of Systems and Control}, Springer, Berlin, 1998. 
    ...
    Systems}, MIT Press, Cambridge, 1961.
...
%      Welsh, Academic Press, New York, 1971, 221--244. 
    ...
    \newblock {\em A student's guide to symplectic
    ...
    \newblock {\em Memoirs of the American Academy of Arts and Sciences},
    9:317--378, 1870. 
...
%    \newblock 
%    \emph{Cah. Top. G\'{e}om. Diff. Cat}, { 43}(3):221--239, 2002.
%    \newblock 
%    \href{http://arxiv.org/abs/math/0110014}{arXiv:math/0110014}.
    ...
    \newblock {\sl Entropy}, 18(4):140.

    \bibitem[Pup62]{Pup62}
    D.\ Puppe.
    \newblock Korrespondenzen in abelschen Kategorien.
    \newblock {\sl Math. Annalen} 148:1--30, 1962.
    ...
    \bibitem[Ros12]{Ros12}
    R.\ Rosen.
    \newblock {\em Anticipatory Systems: Philosophical, Mathematical, and
    Methodological Foundations}, Springer, New York, 2nd ed., 2012.
...
%     AMS, Providence, Rhode Island, 1971, pp.\ 113--118. 
    ...
    Normale Sup\'erieure}, 4({ 30}):605--673, 1997.
    \newblock Also available at
    ...
    \newblock {\sl
    Proc.\ Symp.\ Pure Math.} { 72}:155--205, 2004.
    \newblock Also available as
    \href{http://arxiv.org/abs/math-ph/0304015}{arXiv:math-ph/0304015}.
    
%    \bibitem[Sch01]{Sch01} 
%    R.\ Schweimeier.
%    \newblock {\sl Categorical and Graphical Models of Programming Languages.}
%    \newblock DPhil thesis, University of Sussex, 2001.
    ...
    positive maps.
    \newblock {\sl Proceedings of the 3rd International Workshop on
    Quantum Programming Languages} (QPL 2005), {\sl ENTCS} { 170}(6):
    139--163, 2007.
    \newblock Also available at
    ...
    network theory.
    \newblock {\sl J.\ Diff.\ Geom.} { 7}(1-2):193--210, 1972. 

    \bibitem[Son98]{So} 
    E.\ D.\ Sontag.
    \newblock {\sl Mathematical Control Theory: Deterministic
    Finite Dimensional Systems}. Springer, Berlin, 1998. 
    \newblock Also available at \\
    ...
    by systems biology.
    \newblock {\sl Syst. Biol.} { 1}(1):9--18, 2004. 
    %\newblock Available at \linebreak
...
%      Hodge, {\sl S\'eminaire de Th\'eorie spectrale et g\'eom\'etrie} { 9}
%      (1990-1991), 89--94.
...
%      \'electriques planaire II, {\sl Comment.\ Math.\ Helv.} { 71} (1996),
%      144--167.

%    \bibitem[WW]{WW} S.\ J.\ Wadsley, N.\ Woods. 
...
%    \newblock \href{http://arxiv.org/abs/1505.00048}{arXiv:1505.00048}.
    ...
    \newblock {\sl Bull.\ Amer.\ Math.\ Soc.} { 5}(1):1--13, 1981.
    \newblock Also available at 	
    ...
    \newblock {\sl Rev. Mat. Hisp. Amer.} { 5}(6):153--164, 1923.
    ...
    sciences.
    \newblock {\em Communications on Pure and Applied Mathematics}, 13(1):1--14,
    1960.
    ...
    systems.
    \newblock {\sl IEEE Control Systems Magazine} { 27}:46--99, 2007.
    \newblock Also available at
...
%    after tomorrow.
%    \newblock {\sl European Journal of Control} { 13}:71--81, 2007. 

    \bibitem[Yon54]{Yon54}
    N.\ Yoneda. 
    \newblock On Ext and exact sequences.
    \newblock {\em J. Fac. Sci. Univ. Tokyo}, Sec. I, 7:193--227, 1954.
