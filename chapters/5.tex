...
Willems first demonstrated the power of his behavioural approach in the setting
of linear time-invariant discrete-time dynamical systems. One limitation was the
lack of tools for representing and reasoning about the interconnection of
systems. In this chapter we address this by developing a graphical language
based on signal flow graphs.

We shall use corelations to develop a sound and fully complete equational theory
of linear time-invariant (LTI) dynamical systems.  This theory is
\emph{graphical}, with its terms---modelling the LTI systems themselves---best
represented as diagrams closely resembling the signal flow graphs of
Shannon~\cite{Sh}.  
...
and related $\!\lower7pt\hbox{$\includegraphics[height=.8cm]{pics/badequation2.pdf}$}$
...
interacting Hopf algebras, and indeed, in $\ih_{\k[s]}$:
...
%Let $\sigma$ range over such assignments of values to delays.
