\chapter{Decorated cospans: from closed systems to open} \label{ch.deccospans}
...
of this category and its composition rule, see this paper's introduction. The
main idea is that composition glues together any pair of terminal that have the same
preimage under the cospan maps. An identity morphism is a circuit whose set of
inputs is equal to its set of outputs, with all of its nodes being terminals,
and no edges:
\[
