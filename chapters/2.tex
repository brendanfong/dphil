...
\begin{definition} \label{def:fcospanss}
  ...
  \]
  be a symmetric lax monoidal functor. We define a \define{decorated cospan}, or more
  ...
  \stackrel{s}\rightarrow FN$ is known as the \define{decoration} of the decorated
...
Each cospan may be given the empty decoration. The \define{empty decoration} is the
decoration $1 \stackrel{\varphi_1}{\rightarrow} F\varnothing
\stackrel{F!}{\rightarrow} FN$.

\begin{definition} \label{thm:fcospanss}
...
\section{Example: labelled graphs} \label{sec:ex}
