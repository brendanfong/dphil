...
number of times, also appearing under the names dungeon categories \cite{Mor14}
and dgs-monoidal categories \cite{GH98}. 
...
This theory is all well known, following from theory originally developed for
the dual concept: spans. First discussed by Yoneda \cite{Yon54}, spans are pairs
of morphisms $X \leftarrow N \rightarrow Y$ with a common domain. B\'enabou
introduced the bicategory of objects, spans, and maps of spans in a category
with finite limits as an example of a symmetric monoidal bicategory
\cite{Ben67}. The symmetric monoidal category $\cospan(\mc C)$ is a
decategorified version of symmetric monoidal bicategory of cospans.
...
functors. In the next chapter we show that this extends to a functor from a
