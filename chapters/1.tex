...
\section{Symmetric monoidal categories} \label{sec.smcs}
...
\begin{definition}
  A \define{hypergraph category} is a symmetric monoidal category $(\mc H,\ot)$
...
functor}, is a strong symmetric monoidal functor $(F,\varphi)\maps (\mc
...
of times, also appearing under the names \emph{dgs-monoidal category} \cite{GH98} and \emph{dungeon category} \cite{Mor14}. 
...
\begin{proof}
  ...
  $[x_1:\ldots:x_n]$ of objects of $\mc H$ and morphisms $[x_1:\ldots:x_n] \to
  [y_1:\ldots:y_m]$ those morphisms from $((x_1 \ot x_2) \ot \dots) \ot x_n \to
  ...
  \[
    ...
    \xymatrix{
      ...
      &P([x_1:\ldots:x_n])=((x_1 \ot x_2) \ot \dots ) \ot x_n 
      \phantom{P([x_1:\ldots:x_n])=}
    }
  \]
