...
\section{The category of passive linear networks} \label{sec:circdef}
...
Note that by Section and the work of Courser, we in fact have a symmetric
monoidal bicategory $2\mbox{-}\Circ$ of circuits with 
\begin{itemize}
...
implies that $2\mbox{-}\Circ$ is again a compact closed bicategory \cite{St}.
