...
Next, consider the following example of composition of these
open circuits using decorated cospans:

Note in particular that the composite of these open circuits contains
a unique resistor for every resistor in the factors. This is often unnecessary
for understanding the composite circuit, and thus often wildly inefficient.

For example, consider also the circuit:
...
\end{tikzpicture}
\]
Imagine the following semantics for open circuits. We interact with open
